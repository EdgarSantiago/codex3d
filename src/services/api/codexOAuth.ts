...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Codex3D now.</p>
    <p>Codex3D will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Codex3D.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Codex3D.</p>
  </body>
</html>`
}
